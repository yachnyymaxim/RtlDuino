...
int WiFiClass::apbegin(const char* ssid, const char* channel, bool sta, uint8_t gw0, uint8_t gw1, uint8_t gw2, uint8_t gw3)
{
	uint8_t status = WL_IDLE_STATUS;
...
int WiFiClass::apbegin(const char* ssid, const char* password, const char* channel, bool sta, uint8_t gw0, uint8_t gw1, uint8_t gw2, uint8_t gw3)
{
	uint8_t status = WL_IDLE_STATUS;
